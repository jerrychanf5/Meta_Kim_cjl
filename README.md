...
这部分是 `meta/meta.md` 里非常关键、但以前 README 没写出来的一层。
...
这正是 `meta/meta.md` 里“同一意图，多种交付壳”的工程化版本。
